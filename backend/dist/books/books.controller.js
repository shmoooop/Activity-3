...
__decorate([
    (0, common_1.Post)('seed-sample'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], BooksController.prototype, "seedSample", null);
__decorate([
    (0, common_1.Post)(),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, swagger_2.ApiBody)({ type: update_book_dto_1.UpdateBookDto }),
    (0, swagger_2.ApiResponse)({ status: 200, description: 'Book updated' }),
    __param(0, (0, common_1.Param)('id')),
